...
type ChatRequest struct {
	...
	ToUserId int64  `thrift:"to_user_id,2,required" frugal:"2,required,i64" json:"to_user_id" query:"to_user"`
}
...
type ActionRequest struct {
	...
	ActionType int32  `thrift:"action_type,3,required" frugal:"3,required,i32" json:"action_type" query:"action_type"`
	Content    string `thrift:"content,4,required" frugal:"4,required,string" json:"content" query:"content"`
}
...
type MessageService interface {
	ChatMessage(ctx context.Context, req *ChatRequest) (r *ChatResponse, err error)

	ActionMessage(ctx context.Context, req *ActionRequest) (r *ActionResponse, err error)
}
...
func (p *MessageServiceClient) ChatMessage(ctx context.Context, req *ChatRequest) (r *ChatResponse, err error) {
...
func (p *MessageServiceClient) ActionMessage(ctx context.Context, req *ActionRequest) (r *ActionResponse, err error) {
...
var MessageServiceChatMessageArgs_Req_DEFAULT *ChatRequest

func (p *MessageServiceChatMessageArgs) GetReq() (v *ChatRequest) {
	if !p.IsSetReq() {
		return MessageServiceChatMessageArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *MessageServiceChatMessageArgs) SetReq(val *ChatRequest) {
	p.Req = val
}
...
func (p *MessageServiceChatMessageArgs) Field1DeepEqual(src *ChatRequest) bool {
...
var MessageServiceChatMessageResult_Success_DEFAULT *ChatResponse

func (p *MessageServiceChatMessageResult) GetSuccess() (v *ChatResponse) {
	if !p.IsSetSuccess() {
...
func (p *MessageServiceChatMessageResult) Field0DeepEqual(src *ChatResponse) bool {
...
var MessageServiceActionMessageArgs_Req_DEFAULT *ActionRequest

func (p *MessageServiceActionMessageArgs) GetReq() (v *ActionRequest) {
	if !p.IsSetReq() {
		return MessageServiceActionMessageArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *MessageServiceActionMessageArgs) SetReq(val *ActionRequest) {
	p.Req = val
}
...
func (p *MessageServiceActionMessageArgs) Field1DeepEqual(src *ActionRequest) bool {
...
var MessageServiceActionMessageResult_Success_DEFAULT *ActionResponse

func (p *MessageServiceActionMessageResult) GetSuccess() (v *ActionResponse) {
	if !p.IsSetSuccess() {
...
func (p *MessageServiceActionMessageResult) Field0DeepEqual(src *ActionResponse) bool {
