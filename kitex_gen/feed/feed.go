...
type FeedRequest struct {
	LatestTime int64  `thrift:"latest_time,1" frugal:"1,default,i64" json:"latest_time" query:"latest_time"`
	Token      string `thrift:"token,2" frugal:"2,default,string" json:"token" query:"token"`
}
...
type FeedService interface {
	MGetFeedList(ctx context.Context, req *FeedRequest) (r *FeedResponse, err error)
}
...
func (p *FeedServiceClient) MGetFeedList(ctx context.Context, req *FeedRequest) (r *FeedResponse, err error) {
	var _args FeedServiceMGetFeedListArgs
	_args.Req = req
	var _result FeedServiceMGetFeedListResult
	if err = p.Client_().Call(ctx, "MGetFeedList", &_args, &_result); err != nil {
		return
	}
...
func NewFeedServiceProcessor(handler FeedService) *FeedServiceProcessor {
	...
	self.AddToProcessorMap("MGetFeedList", &feedServiceProcessorMGetFeedList{handler: handler})
	return self
}
...
type feedServiceProcessorMGetFeedList struct {
	handler FeedService
}

func (p *feedServiceProcessorMGetFeedList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FeedServiceMGetFeedListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("MGetFeedList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FeedServiceMGetFeedListResult{}
	var retval *FeedResponse
	if retval, err2 = p.handler.MGetFeedList(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing MGetFeedList: "+err2.Error())
		oprot.WriteMessageBegin("MGetFeedList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("MGetFeedList", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
...
type FeedServiceMGetFeedListArgs struct {
	Req *FeedRequest `thrift:"req,1" frugal:"1,default,FeedRequest" json:"req"`
}

func NewFeedServiceMGetFeedListArgs() *FeedServiceMGetFeedListArgs {
	return &FeedServiceMGetFeedListArgs{}
}

func (p *FeedServiceMGetFeedListArgs) InitDefault() {
	*p = FeedServiceMGetFeedListArgs{}
}

var FeedServiceMGetFeedListArgs_Req_DEFAULT *FeedRequest

func (p *FeedServiceMGetFeedListArgs) GetReq() (v *FeedRequest) {
	if !p.IsSetReq() {
		return FeedServiceMGetFeedListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FeedServiceMGetFeedListArgs) SetReq(val *FeedRequest) {
	p.Req = val
}

var fieldIDToName_FeedServiceMGetFeedListArgs = map[int16]string{
	1: "req",
}

func (p *FeedServiceMGetFeedListArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *FeedServiceMGetFeedListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceMGetFeedListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceMGetFeedListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *FeedServiceMGetFeedListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MGetFeedList_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *FeedServiceMGetFeedListArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *FeedServiceMGetFeedListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceMGetFeedListArgs(%+v)", *p)
}

func (p *FeedServiceMGetFeedListArgs) DeepEqual(ano *FeedServiceMGetFeedListArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceMGetFeedListArgs) Field1DeepEqual(src *FeedRequest) bool {
...
type FeedServiceMGetFeedListResult struct {
	Success *FeedResponse `thrift:"success,0,optional" frugal:"0,optional,FeedResponse" json:"success,omitempty"`
}

func NewFeedServiceMGetFeedListResult() *FeedServiceMGetFeedListResult {
	return &FeedServiceMGetFeedListResult{}
}

func (p *FeedServiceMGetFeedListResult) InitDefault() {
	*p = FeedServiceMGetFeedListResult{}
}

var FeedServiceMGetFeedListResult_Success_DEFAULT *FeedResponse

func (p *FeedServiceMGetFeedListResult) GetSuccess() (v *FeedResponse) {
	if !p.IsSetSuccess() {
		return FeedServiceMGetFeedListResult_Success_DEFAULT
	}
	return p.Success
}
func (p *FeedServiceMGetFeedListResult) SetSuccess(x interface{}) {
	p.Success = x.(*FeedResponse)
}

var fieldIDToName_FeedServiceMGetFeedListResult = map[int16]string{
	0: "success",
}

func (p *FeedServiceMGetFeedListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *FeedServiceMGetFeedListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceMGetFeedListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceMGetFeedListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *FeedServiceMGetFeedListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MGetFeedList_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *FeedServiceMGetFeedListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *FeedServiceMGetFeedListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceMGetFeedListResult(%+v)", *p)
}

func (p *FeedServiceMGetFeedListResult) DeepEqual(ano *FeedServiceMGetFeedListResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceMGetFeedListResult) Field0DeepEqual(src *FeedResponse) bool {
