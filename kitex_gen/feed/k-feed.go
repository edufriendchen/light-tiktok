...
func (p *FeedServiceMGetFeedListArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceMGetFeedListArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *FeedServiceMGetFeedListArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *FeedServiceMGetFeedListArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *FeedServiceMGetFeedListArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "MGetFeedList_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *FeedServiceMGetFeedListArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("MGetFeedList_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *FeedServiceMGetFeedListArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FeedServiceMGetFeedListArgs) field1Length() int {
	l := 0
...
func (p *FeedServiceMGetFeedListResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceMGetFeedListResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *FeedServiceMGetFeedListResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *FeedServiceMGetFeedListResult) FastWrite(buf []byte) int {
	return 0
}

func (p *FeedServiceMGetFeedListResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "MGetFeedList_result")
	if p != nil {
...
func (p *FeedServiceMGetFeedListResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("MGetFeedList_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *FeedServiceMGetFeedListResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *FeedServiceMGetFeedListResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *FeedServiceMGetFeedListArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *FeedServiceMGetFeedListResult) GetResult() interface{} {
	return p.Success
}
